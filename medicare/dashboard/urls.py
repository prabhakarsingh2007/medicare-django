...
urlpatterns = [
    ...
    path("admin/edit_hospital/<int:pk>/", edit_hospital, name="edit_hospital"),
    path("admin/toggle_hospital_status/<int:pk>/", toggle_hospital_status, name="toggle_hospital_status"),
